...
func (m *EndpointChangeRequest) validateEnabled(formats strfmt.Registry) error {
...
func (m *EndpointChangeRequest) validateID(formats strfmt.Registry) error {
...
// ContextValidate validates this endpoint change request based on context it is used
