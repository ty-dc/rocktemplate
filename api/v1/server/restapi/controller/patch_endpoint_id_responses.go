...
func (o *PatchEndpointIDInvalid) WithPayload(payload *models.ErrorRes) *PatchEndpointIDInvalid {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the patch endpoint Id invalid response
func (o *PatchEndpointIDInvalid) SetPayload(payload *models.ErrorRes) {
	o.Payload = payload
}
...
func (o *PatchEndpointIDFailed) WithPayload(payload *models.ErrorRes) *PatchEndpointIDFailed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the patch endpoint Id failed response
func (o *PatchEndpointIDFailed) SetPayload(payload *models.ErrorRes) {
	o.Payload = payload
}
