...
func (o *DeleteEndpointIDInvalid) WithPayload(payload *models.ErrorRes) *DeleteEndpointIDInvalid {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete endpoint Id invalid response
func (o *DeleteEndpointIDInvalid) SetPayload(payload *models.ErrorRes) {
	o.Payload = payload
}
