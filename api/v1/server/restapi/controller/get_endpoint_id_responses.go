...
type GetEndpointIDOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.EndpointStatus `json:"body,omitempty"`
}
...
func (o *GetEndpointIDOK) WithPayload(payload *models.EndpointStatus) *GetEndpointIDOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get endpoint Id o k response
func (o *GetEndpointIDOK) SetPayload(payload *models.EndpointStatus) {
	o.Payload = payload
}
...
func (o *GetEndpointIDInvalid) WithPayload(payload *models.ErrorRes) *GetEndpointIDInvalid {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get endpoint Id invalid response
func (o *GetEndpointIDInvalid) SetPayload(payload *models.ErrorRes) {
	o.Payload = payload
}
