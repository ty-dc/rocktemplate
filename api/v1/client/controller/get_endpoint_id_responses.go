...
func (o *GetEndpointIDOK) GetPayload() *models.EndpointStatus {
	return o.Payload
}
...
func (o *GetEndpointIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.EndpointStatus)
...
func (o *GetEndpointIDInvalid) GetPayload() *models.ErrorRes {
	return o.Payload
}
